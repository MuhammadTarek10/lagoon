...
namespace Lagoon.Application.Services.Implementations
{
    public class DashboardService : IDashboardService
    {
        ...
        {
            var totalBookings = await _unitOfWork.Booking.GetAllAsync(u => u.BookingDate >= DateTime.Now.AddDays(-30) &&
        ...
        {
            var bookingData = (await _unitOfWork.Booking.GetAllAsync(u => u.BookingDate >= DateTime.Now.AddDays(-30) &&
            ...
            var customerData = (await _unitOfWork.User.GetAllAsync(u => u.CreatedAt >= DateTime.Now.AddDays(-30) &&
        ...
        public async Task<RadialBarChartDto> GetRegisteredUserChartData()
        {
            ...
            var totalUsers = await _unitOfWork.User.GetAllAsync();
        ...
        {
            var totalBookings = await _unitOfWork.Booking.GetAllAsync(u => u.Status != SD.StatusPending
