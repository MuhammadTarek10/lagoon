...
function loadTotalBookingRadialChart() {
  ...
  $.ajax({
    ...
    success: function (data) {
      document.querySelector("#spanTotalBookingCount").innerHTML =
        data.totalCount;
      ...
      if (data.hasRatioIncreased) {
        ...
        sectionCurrentCount.innerHTML =
          '<i class="bi bi-arrow-up-right-circle me-1"></i> <span> ' +
          data.countInCurrentMonth +
          "</span>";
      } else {
        sectionCurrentCount.className = "text-danger me-1";
        sectionCurrentCount.innerHTML =
          '<i class="bi bi-arrow-down-right-circle me-1"></i> <span> ' +
          data.countInCurrentMonth +
          "</span>";
      }

      document
        .querySelector("#sectionBookingCount")
        .append(sectionCurrentCount);
